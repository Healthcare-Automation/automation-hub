    ...
    <div className="flex min-h-screen items-center justify-center px-5">
      <form onSubmit={submit} className="w-full max-w-sm rounded-2xl border border-zinc-200 bg-white p-7 shadow-sm">
        ...
        <input
          ...
          className="mt-6 w-full rounded-lg border border-zinc-300 px-3 py-2.5 text-sm outline-none focus:border-emerald-600"
          required
        />
        <button
          type="submit"
          disabled={loading || !code}
          className="mt-3 w-full rounded-lg bg-emerald-700 px-4 py-2.5 text-sm font-medium text-white disabled:bg-zinc-300"
        >
