...
export const CHART = {
  ...
  reference: 'bg-slate-700/60',
  /** Empty bar track. */
  track: 'bg-zinc-800/40',
...
export const CHART_HOVER = {
  primary: 'group-hover:bg-cyan-300/75',
  good: 'group-hover:bg-teal-200/80',
  warn: 'group-hover:bg-orange-200/70',
  neutral: 'group-hover:bg-slate-300/60',
  reference: 'group-hover:bg-slate-600/70',
} as const

/** Text tones that pair with the fills, for figures printed beside a bar. */
export const CHART_TEXT = {
  good: 'text-teal-300/80',
  warn: 'text-orange-300/75',
